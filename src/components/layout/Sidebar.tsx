...
import { GroupCreateModal, GroupEditModal } from "./SidebarGroupModals";
import { TagRenameModal } from "./SidebarTagRenameModal";
import { BroadcastGroupEditModal } from "./SidebarBroadcastGroupEditModal";
import NavRow from "./SidebarNavRow";
import GroupRow from "./SidebarGroupRow";
import TagRow from "./SidebarTagRow";
    ...
    <aside className="w-52 shrink-0 bg-surface-0 border-r border-stroke-subtle flex flex-col">
      ...
      <div className="px-2 pb-1 border-t border-stroke-subtle pt-1">
        <NavRow
          ...
          label={
            <span className="flex items-center gap-2">
              <svg className="w-3.5 h-3.5 shrink-0 text-muted" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
