...
- Files: PascalCase for components (`ServerCard.tsx`), camelCase for hooks/stores/utilities (`serverStore.ts`, `useAppInit.ts`, `clipboardClear.ts`), snake_case for Rust modules (standard).
